# -*- coding: utf-8 -*-
"""E-24g 관문 ⑤ — −Br 100(E-23 편입 조건, 등록 형태 상한 12). `run_e24_gate5.py` 사본 — 바꾼 것: 대상 · 폴더(e24g_g5_stage · lmp_e24g_g5) · 출력 이름. 원판 머리말:
...
STAGE = os.path.join(HERE, 'e24g_g5_stage'); rs.STRUCT = STAGE; rs.WORK = os.path.join(HERE, 'lmp_e24g_g5')
OUT = os.path.join(HERE, f'results_e24g_gate5_{socket.gethostname().lower()}.json')
TAGS = ['e24g_br_100']
