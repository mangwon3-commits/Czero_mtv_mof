# -*- coding: utf-8 -*-
"""E-24i 관문 ⑤ — 열린 자리 치환체(등록 형태 상한 12, 대상 = 명령줄 쉼표 목록). `run_e24g_gate5.py` 사본. 원판: E-24g 관문 ⑤ — −Br 100(E-23 편입 조건, 등록 형태 상한 12). `run_e24_gate5.py` 사본 — 바꾼 것: 대상 · 폴더(e24g_g5_stage · lmp_e24g_g5) · 출력 이름. 원판 머리말:
...
STAGE = os.path.join(HERE, 'e24i_g5_stage'); rs.STRUCT = STAGE; rs.WORK = os.path.join(HERE, 'lmp_e24i_g5')
OUT = os.path.join(HERE, f'results_e24i_gate5_{socket.gethostname().lower()}.json')
