"""E-24g · E-24h 들어가는가 관문(등록 §HKHOME 21차 (0)) — `e24c_measure.py` 사본(대상 · 경로 · 출력 · Br···H 만 바꿈). 그 원문: E-24c 들어가는가 관문(등록 §HKHOME 16차 (0)) — `e24_measure.py` 사본(그 파일은 import 하면 E-24 결과를 다시 써서 복사함), 대상 · 경로 · 출력만 바꿈.
...
TAGS = {'e24g_br_100': 'E24g_ZnDia_Br_100', 'e24g_cch_100': 'E24g_ZnDia_CCH_100', 'e24g_cf3_100': 'E24g_ZnDia_CF3_100', 'e24g_nc3h7_100': 'E24g_ZnDia_nC3H7_100',
        'e24h_c2h5_050a': 'E24h_ZnDia_C2H5_050a', 'e24h_c2h5_050b': 'E24h_ZnDia_C2H5_050b', 'e24h_cl_050a': 'E24h_ZnDia_Cl_050a', 'e24h_cl_050b': 'E24h_ZnDia_Cl_050b'}
...
for tag, cif in TAGS.items():
    a0 = read(f'e24g_candidates/{cif}.cif'); a1 = read(f'relax_tnf/{tag}_relaxed.cif'); assert len(a0) == len(a1)
...
json.dump(res, open('results_e24g_fit_hkhome.json', 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
