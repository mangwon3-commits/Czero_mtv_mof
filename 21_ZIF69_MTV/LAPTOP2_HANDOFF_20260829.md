...
## 3c. frozen-framework 검정 — **완주·보고 완료** (09-03 09:15, 커밋 ad931aa)
...
**상위 판정 함의**: nbIm025 유지율 87.60±2.33% 를 쓸 때 frozen-framework
리스크 병기 **유지**. 병기 문구는 좁혀도 됨 — "물은 Zn 배위 자리(~2.3 A)에
국소 극소로 존재하나 두 자리 모두 Zn-N 개방 없음. 강체 GCMC 가 놓치는 것은
배위 자체이고, 이 수준에서 상전이 증거는 못 얻음."

**데스크탑 답 대기 1건**: 자리 의존(C1 -23.86% / 1596cyc 대 C2 -1.50% / 52cyc,
22%p 차)을 근거로 ②③ 을 "분지 의존" 으로 격하 기록할지. ① 은 두 자리 0.009 A
차로 견고.
