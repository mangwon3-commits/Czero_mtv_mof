# 배정 — 습윤(RH90) 밀도 격자 **사다리 메우기** (2026-09-24 **16:4x**, 데스크탑 종합자)
...
## 0. 지금 있는 것 — **8조성 전부 완주 표지 확인**(16:3x, `Simulation finished`)
...
⚠ **관문 6/6 확인**(16:4x): saIm025 6.69 % · mslm025 5.25 % · cf3Im025 1.27 % — **셋 다 통과**.
