# -*- coding: utf-8 -*-
"""MAGI-005 E-24g · E-24h (데스크탑) 막음 Widom — 닿지 않는 주머니가 나온 새 치환체의 BlockPockets Widom, 전하 ON/OFF.
...
OUT = os.path.join(HERE, 'results_e24g_blockpockets_hkhome.json')
...
def main():
    ...
    out = {'test': 'MAGI-005 E-24g · E-24h 막음 Widom(BlockPockets) — 주머니 있는 새 치환체, 전하 ON/OFF', 'machine': 'hkhome', 'ported_from': 'junseok magi5_e24c_bp_junseok.py (db4346e2)',
           'assign': 'ASSIGN_MAGI5B_20260925.md §HKHOME 21차', 'zeo': 'E-24g -ha -block r 50000 (results_e24g_access_hkhome.json)',
