...
OUTD = os.path.join(REAL, "density_v3_tpl2")
os.makedirs(OUTD, exist_ok=True)
rd.HERE = OUTD
rd.OUT = OUTD
rd.CHARGED = os.path.join(REAL, "charged_v3")
rd.MAX_WORKERS = int(os.environ.get("DENSITY_TPL2_WORKERS", "4"))
rd.TARGETS = ["e24c_cl_100", "e24c_c2h5_100"]
BLOCK = {"e24c_c2h5_100_DDEC6": os.path.join(REAL, "e28b_blocks", "e24c_c2h5_100_block1.65.block")}
...
if __name__ == "__main__":
    print("밀도맵 E-28b 건조 — Cl · C₂H₅(막음)", flush=True)
    for t in rd.TARGETS:
