"""자리 배치 앙상블 — saIm050 을 다른 시드 5개로 다시 만든다.
...
EXPECT_EL = {"Zn": 24, "C": 246, "N": 120, "O": 60, "Cl": 18, "S": 6, "H": 162}   # structures_v2/ZIF69_mslm025.cif 실측 (09-09)
...
def main():
    ap = argparse.ArgumentParser(description="mslm025 자리 배치 앙상블 생성 (ASSIGN §Q ②, 09-09)")
    ...
    for seed in range(1, MAX_SEED):
        ...
        rows.append({"tag": tag, "sub": "mslm_aryl", "group": "-SO2CH3",
                     ...
                     "note": "09-09 mslm025 자리 배치 앙상블 (ASSIGN_20260907 §Q ② 자 확보). e 뒤 숫자 = 빌더 시드. "
