...
[대상 3종]
    ...
    saIm100 은 수분 종료 판정이므로 제외한다.
    [2026-08-20 정정] "종료" 는 v1 값(38.1%) 기준의 당시 판정. v3 정본은
    60.6 ± 2.0% 로 **조건부**이며, v3 습윤 실행(run_humid_wc_v3)은 saIm100
    을 포함했다. saIm025 는 유지율 92.1% 로 이미
