...
Zeo++ 는 한 건에 3.2 GB 입니다.

> **[2026-08-22 정정] 3.2 GB 는 v1 구조에서 잰 값입니다. v3 구조는 실측 9.5 GB/건**
> 입니다(이완으로 셀이 34% 수축해 슈퍼셀 원자 수가 늘었습니다). 아래 워커 수를
> 그대로 쓰지 말고 `ZEO_GB_PER_JOB` 으로 덮거나 기기에서 다시 계산하세요. 08-12 에 RASPA 위에 8워커로 얹었다가 OOM 이
