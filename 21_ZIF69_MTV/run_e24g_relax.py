# -*- coding: utf-8 -*-
"""MAGI-005 E-24g · E-24h (HKHOME 21차) — 새 치환체 · 희석 실현의 UFF4MOF 셀 이완(상한 300, 수렴 EDiff < 1e-4). 등록 ASSIGN_MAGI5B §HKHOME 21차(자료 0건).
...
CAP = 300
STAGE = os.path.join(HERE, 'e24g_stage')
WORK = os.path.join(HERE, 'lmp_e24g')
OUT = os.path.join(HERE, 'results_e24g_relax300_hkhome.json')
...
if __name__ == '__main__':
    ...
    os.makedirs(WORK)
    t0 = time.time()
    res = {'test': 'MAGI-005 E-24g · E-24h — UFF4MOF 이완 수렴(상한 300)', 'assign': 'ASSIGN_MAGI5B_20260925.md §HKHOME 21차', 'machine': 'hkhome',
