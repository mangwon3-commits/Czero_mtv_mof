...
CAP = 300
STAGE = os.path.join(HERE, 'e24i_stage')
WORK = os.path.join(HERE, 'lmp_e24i')
OUT = os.path.join(HERE, f"results_e24i_relax300_{os.environ.get('E24I_MACHINE', 'hkhome')}.json")
